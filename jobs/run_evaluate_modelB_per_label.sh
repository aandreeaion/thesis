#!/bin/bash
#SBATCH --job-name=modelB_per_label
#SBATCH --output=jobs/modelB_per_label_%j.out
#SBATCH --error=jobs/modelB_per_label_%j.err
...
echo "Starting evaluation Model B per label..."
python scripts/evaluate_modelB_per_label.py
