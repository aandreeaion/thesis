#!/bin/bash
#SBATCH --job-name=modernbert_optuna_larger_batch_merged
#SBATCH --output=jobs/modernbert_optuna_larger_batch_merged_%j.out
#SBATCH --error=jobs/modernbert_optuna_larger_batch_merged_%j.err
...
echo "Starting Optuna relaxed tuning with full documents and larger batch-size search for 5 labels..."
python scripts/optuna_modernBERT_relaxed_merged_larger_batch.py
