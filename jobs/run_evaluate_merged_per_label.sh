#!/bin/bash
#SBATCH --job-name=merged_per_label
#SBATCH --output=jobs/merged_per_label_%j.out
#SBATCH --error=jobs/merged_per_label_%j.err
...
echo "Starting evaluation merged model per label..."
python scripts/evaluate_merged_per_label.py
