#!/bin/bash
#SBATCH --job-name=modernbert_optuna_relaxed_1024
#SBATCH --output=jobs/modernbert_optuna_relaxed_1024_%j.out
#SBATCH --error=jobs/modernbert_optuna_relaxed_1024_%j.err
...
echo "Starting Optuna relaxed tuning with max_length=1024..."
python scripts/optuna_modernBERT_relaxed_1024.py
