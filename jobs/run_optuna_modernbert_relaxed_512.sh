#!/bin/bash
#SBATCH --job-name=modernbert_optuna_relaxed_512
#SBATCH --output=jobs/modernbert_optuna_relaxed_512_%j.out
#SBATCH --error=jobs/modernbert_optuna_relaxed_512_%j.err
...
echo "Starting Optuna relaxed tuning with max_length=512..."
python scripts/optuna_modernBERT_relaxed_512.py
