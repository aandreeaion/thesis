#!/bin/bash
#SBATCH --job-name=modernbert_optuna
#SBATCH --output=jobs/modernbert_optuna_%j.out
#SBATCH --error=jobs/modernbert_optuna_%j.err
...
python scripts/optuna_modernBERT.py
