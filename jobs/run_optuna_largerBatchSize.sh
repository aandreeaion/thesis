#!/bin/bash
#SBATCH --job-name=modernbert_optuna_larger_batch
#SBATCH --output=jobs/modernbert_optuna_larger_batch_%j.out
#SBATCH --error=jobs/modernbert_optuna_larger_batch_%j.err
...
echo "Starting Optuna relaxed tuning with full documents and larger batch-size search..."
python scripts/optuna_largerBatchSize.py
