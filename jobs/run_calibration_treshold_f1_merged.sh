#!/bin/bash
#SBATCH --job-name=modernbert_calib_treshold_f1_merged
#SBATCH --output=jobs/modernbert_calib_treshold_f1_merged_%j.out
#SBATCH --error=jobs/modernbert_calib_treshold_f1_merged_%j.err
...
echo "Starting merged temperature calibration treshold f1..."
python scripts/calibration_treshold_f1_merged.py
