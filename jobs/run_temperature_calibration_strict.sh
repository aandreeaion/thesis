#!/bin/bash
#SBATCH --job-name=modernbert_calibration_strict
#SBATCH --output=jobs/modernbert_calibration_strict_%j.out
#SBATCH --error=jobs/modernbert_calibration_strict_%j.err
...
echo "Starting temperature calibration strict version..."
python scripts/temperature_calibration_strict.py
