#!/bin/bash
#SBATCH --job-name=modernbert_calibration
#SBATCH --output=jobs/modernbert_calibration_%j.out
#SBATCH --error=jobs/modernbert_calibration_%j.err
...
python scripts/temperature_calibration.py
