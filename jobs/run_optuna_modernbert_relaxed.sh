#!/bin/bash
#SBATCH --job-name=modernbert_optuna_relaxed
#SBATCH --output=jobs/modernbert_optuna_relaxed_%j.out
#SBATCH --error=jobs/modernbert_optuna_relaxed_%j.err
...
echo "Starting Optuna tuning..."
python scripts/optuna_modernBERT_relaxed.py
