#!/bin/bash
#SBATCH --job-name=modernbert_final_merged_optuna
#SBATCH --output=jobs/modernbert_final_merged_optuna_%j.out
#SBATCH --error=jobs/modernbert_final_merged_optuna_%j.err
...
python scripts/train_final_modernBERT_merged_optuna.py
