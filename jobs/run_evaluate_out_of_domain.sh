#!/bin/bash
#SBATCH --job-name=evaluate_out_of_domain
#SBATCH --output=jobs/evaluate_out_of_domain_%j.out
#SBATCH --error=jobs/evaluate_out_of_domain_%j.err
...
echo "Starting out-of-domain evaluation on AllSides 45 news articles..."
python scripts/evaluate_out_of_domain.py
