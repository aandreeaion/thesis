#!/bin/bash
#SBATCH --job-name=modernbert_final_strict
#SBATCH --output=jobs/modernbert_final_strict_%j.out
#SBATCH --error=jobs/modernbert_final_strict_%j.err
...
echo "Starting strict-selected final ModernBERT training and test evaluation..."
python scripts/train_final_modernBERT_strict.py
