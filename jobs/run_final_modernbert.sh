#!/bin/bash
#SBATCH --job-name=modernbert_final
#SBATCH --output=jobs/modernbert_final_%j.out
#SBATCH --error=jobs/modernbert_final_%j.err
...
echo "Starting final ModernBERT training and test evaluation..."
python scripts/train_final_modernBERT.py
