#!/bin/bash
#SBATCH --job-name=modernbert_optuna_relaxed_merged
#SBATCH --output=jobs/modernbert_optuna_relaxed_merged_%j.out
#SBATCH --error=jobs/modernbert_optuna_relaxed_merged_%j.err
...
echo "Starting Optuna tuning with 5 labels..."
python scripts/optuna_modernBERT_relaxed_merged.py
