"""
Temperature calibration + validation-threshold tuning for final ModernBERT token-classification models.
...
- strict and relaxed validation F1 before/after calibration;
- strict and relaxed validation F1 after confidence thresholding.
"""
...
CALIBRATION_OUTPUT_FILE = OUTPUT_DIR / "temp_calibration_threshold_f1-validation_results.json"
