"""
This script trains a final ModernBERT token-classification model using the merged
label scheme, where common-ground is recoded as assumption.

It uses the best relaxed-F1 Optuna hyperparameters from the merged 5-label setup
and evaluates the model on the merged Webis Editorials test set.
"""
...
MODEL_VERSION = "merged_optuna_selected"
MODEL_NAME = "answerdotai/ModernBERT-base"

DATA_DIR = Path("data/bio_modernbert_tokens")
OUTPUT_DIR = Path("outputs/modernbert_webis_final_merged_optuna_selected")
...
# Selection block for the new best hyperparameters from Optuna for 5 labels 
FINAL_CONFIGS = {
    "merged_optuna_selected": {
        "selection_metric": "relaxed_f1",
        "learning_rate": 4.9514435461857654e-05,
        "weight_decay": 0.056954982280788144,
        "num_train_epochs": 4,
        "warmup_ratio": 0.07732503430087254,
