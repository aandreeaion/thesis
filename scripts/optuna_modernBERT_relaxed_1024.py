...
OUTPUT_DIR = Path("outputs/modernbert_webis_token_classification_optuna_relaxed_1024")
TRAIN_FILE = DATA_DIR / "webis_editorials_train_bio_modernbert_1024.jsonl"
VALIDATION_FILE = DATA_DIR / "webis_editorials_validation_bio_modernbert_1024.jsonl"
...
def main():
    ...
    study = optuna.create_study(
        direction="maximize",
        study_name="modernbert_webis_token_classification_relaxed_1024",
    )
