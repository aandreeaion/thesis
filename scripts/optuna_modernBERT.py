...
OUTPUT_DIR = Path("outputs/modernbert_webis_token_classification_optuna")
...
def compute_metrics(eval_prediction):
    """
    Computing standard seqeval precision, recall, F1, and accuracy
...
def objective(trial):
    ...
    lr_scheduler_type = trial.suggest_categorical(
        "lr_scheduler_type",
        ["linear", "cosine", "cosine_with_warmup"],
    )
    ...
    print(f"Trial {trial.number} validation F1: {validation_f1}")
    ...
    # Keeping disk use manageable by deleting trial checkpoints after evaluation
...
def save_best_results(study):
    ...
    results = {
        ...
        "best_validation_f1": best_trial.value,
    ...
    print("  Validation F1:", best_trial.value)
    print("  Parameters:")
...
def main():
    ...
    study = optuna.create_study(
        direction="maximize",
        study_name="modernbert_webis_token_classification",
    )
