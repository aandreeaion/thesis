...
OUTPUT_DIR = Path("outputs/modernbert_webis_token_classification_optuna_relaxed_256")
TRAIN_FILE = DATA_DIR / "webis_editorials_train_bio_modernbert_256.jsonl"
VALIDATION_FILE = DATA_DIR / "webis_editorials_validation_bio_modernbert_256.jsonl"
...
def main():
    ...
    study = optuna.create_study(
        direction="maximize",
        study_name="modernbert_webis_token_classification_relaxed_256",
    )
