"""
Evaluate Model B per label on the Webis test split.

This script loads the saved relaxed-selected ModernBERT model,
predicts BIO labels for the Webis test set, and computes:
...
OUTPUT_CSV = OUTPUT_DIR / "webis_test_per_label_results.csv"
OUTPUT_JSON = OUTPUT_DIR / "webis_test_per_label_results.json"
