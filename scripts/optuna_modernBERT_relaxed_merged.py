...
OUTPUT_DIR = Path("outputs/modernbert_webis_token_classification_optuna_relaxed_merged")
...
def main():
    ...
    study = optuna.create_study(
        direction="maximize",
        study_name="modernbert_webis_token_classification_relaxed_merged",
    )
